...
public record ExamCategoryDto   (int Id, string Name, bool IsActive, int SortOrder) : MasterDto(Id, Name, IsActive, SortOrder);
public record ExamSubCategoryDto(int Id, string Name, bool IsActive, int SortOrder, int ExamCategoryId, string ExamCategoryName)
    : MasterDto(Id, Name, IsActive, SortOrder);
...
public record CreateExamSubCategoryRequest(string Name, int ExamCategoryId, bool IsActive = true, int SortOrder = 0);
